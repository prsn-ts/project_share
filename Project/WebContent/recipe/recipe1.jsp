		...
		<div class="form-group" style="text-align: right; margin-top:30px;">
			<table class="table table-striped"
				...
				<thead>
					<tr>
						<th colspan="2"
							style="background-color: #eeeeee; text-align: center;">오늘의 추천 레시피 중화풍의 매콤한 채소 잡채밥! </th>
					</tr>
				</thead>
				<tbody>
					...
					<tr>
						...
						<img src="https://newsimg.hankookilbo.com/cms/articlerelease/2016/01/06/201601061734385239_1.jpg"/>

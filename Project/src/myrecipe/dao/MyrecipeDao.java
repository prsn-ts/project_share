...
public class MyrecipeDao {
	...
	public MyrecipeDto getData1() {
		...
		try {
			...
			//실행할 sql 문 준비하기
			String sql = "SELECT num,title,subTitle,content,writer,regdate,imagePath,showImage,viewCount,prevNum,nextNum"
					+ " FROM my_recipe";
			...
			if (rs.next()) {
				...
				dto.setTitle(rs.getString("subTitle"));
				dto.setContent(rs.getString("content"));
				dto.setWriter(rs.getString("writer"));
				dto.setRegdate(rs.getString("regdate"));
				dto.setContent(rs.getString("imagePath"));
				dto.setContent(rs.getString("showImage"));

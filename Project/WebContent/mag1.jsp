...
<body>
	...
	<div style="background-color: white">
		...
		<div align="center">
			...
			<p class="card-text">성장기에 있는 아이들은 근육 형성을 위한 단백질,
...
단백질의 일종인 콜라겐은 뼈를 만드는 작용을 합니다</p>
		</div>
		</div>
		</div>
		...
		<div align="center">
			...
			<p class="card-text">우유 안에는 뼈를 튼튼하게 해주는 칼슘이 많아
...
장수에 있어서 뼈 건강은 필수인데
우유를 섭취해주면 튼튼한 뼈를 만들 수 있겠죠?<br><br></p>
		</div>
		</div>
		</div>
		...
		<div class="card h-100">
		<div align="center">
			<img class="img-fluid" src="images/mag3.png" style="width: 600px; height:600px;" >
			</div>
			<div class="card-body" >
			<h5 class="card-title">두뇌가 발달한다!</h5>
			<p class="card-text">두뇌 작용이 활발하게 이뤄지려면 무엇보다 균형 잡힌 영양소를 섭취해야 한다. 
...
적절한 양의 갈락토오스를 섭취하면 두뇌 활동이 활발해진다.</p>
		</div>
	</div>
	</div>
	</div>
